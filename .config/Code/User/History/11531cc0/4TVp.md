...
# ml-api-1  | INFO:     172.18.0.1:35970 - "GET /ping HTTP/1.1" 200 OK
curl http://localhost:8000/health 
# Should get inside curl terminal:
# {"status":"healthy"} 
# and inside server terminal / logs:
# ml-api-1  | INFO:     172.18.0.1:35978 - "GET /health HTTP/1.1" 200 OK
curl http://localhost:8000/react
# Should get inside curl terminal:
# {"message":"react workflow"}
# and inside server terminal / logs:
# ml-api-1  | INFO:     172.18.0.1:35986 - "GET /react HTTP/1.1" 200 OK
```

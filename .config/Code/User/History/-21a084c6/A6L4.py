...
class ChatHistory(BaseModel):
    ...
    def add_user(self, content: Optional[str] = None, **kwargs: Any) -> Message:
        msg = Message(role=Role.user, content=content, **kwargs)
        self.messages.append(msg)
        return msg

    def add_assistant(self, content: Optional[str] = None, **kwargs: Any) -> Message:
        msg = Message(role=Role.assistant, content=content, **kwargs)
        self.messages.append(msg)
        return msg
